...
pub enum DecodedSyscall {
    ...
    GetRobustList(syscall::robust_list::GetRobustList),
    SetRobustList(syscall::robust_list::SetRobustList),

    SetTidAddress(syscall::tid::SetTidAddress),

    Lseek(syscall::lseek::Lseek),
    Llseek(syscall::lseek::Llseek),

    ExitGroup(syscall::exit::ExitGroup),
